...
run "install frontend dependencies" bash -lc "cd '$FRONTEND_DIR' && NODE_OPTIONS=--max-old-space-size=640 npm install --no-audit --no-fund --prefer-offline --omit=optional"
