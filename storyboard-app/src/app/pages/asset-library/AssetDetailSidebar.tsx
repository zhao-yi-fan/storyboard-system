...
import { ASSET_KIND, ENTITY_TYPE, GENERATION_STATUS } from "../../constants/domain";
                  ...
                  <div className={styles.detailSections}>
                    <div className={styles.detailCard}>
                      ...
                      <div className={styles.buttonRow}>
                        <input
                          ...
                          onChange={(e) =>
                            void handleUploadSelectedCharacterReference(e.target.files?.[0] ?? null)
                          }
                        />
                        <Button
                          type="button"
                    ...
                    <div className={styles.detailCard}>
                      ...
                      <div>
                        ...
                        />
                        <div className={styles.fieldHint}>系统会在生成时追加 3-5 秒短句约束。</div>
                      </div>
                      <div>
