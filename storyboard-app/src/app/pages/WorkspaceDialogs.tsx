...
import { type VideoPreview,VideoPreviewDialog } from "../components/workspace/dialogs/VideoPreviewDialog";
...
type PromptDialogsProps = {
  ...
  setDescriptionOptimization: (
    value:
      ...
      | ((current: DescriptionOptimization) => DescriptionOptimization),
  ) => void;
...
type PreviewDialogsProps = {
  ...
  handleInsertVideoFrame: (file: File, timestampMs: number, targetScene: Scene) => Promise<SceneVideoFrame>;
