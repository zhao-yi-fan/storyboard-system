...
CREATE TABLE IF NOT EXISTS characters (
    ...
    voice_reference_url VARCHAR(500) COMMENT '角色主语音参考URL',
    voice_reference_duration DECIMAL(8,2) COMMENT '角色主语音参考时长（秒）',
    voice_reference_text TEXT COMMENT '角色主语音参考文本',
    voice_name VARCHAR(100) COMMENT '角色主语音名称',
    voice_prompt TEXT COMMENT '角色主语音提示词',
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_at DATETIME NULL,
    FOREIGN KEY (project_id) REFERENCES projects(id),
