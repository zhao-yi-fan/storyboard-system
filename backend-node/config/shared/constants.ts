...
export const DEFAULT_DEEPSEEK_TIMEOUT_SECONDS = 180;
export const DEFAULT_DASHSCOPE_VOICE_TIMEOUT_SECONDS = 120;
export const DEFAULT_WANX_TIMEOUT_SECONDS = 300;
export const DEFAULT_WANX_VIDEO_TIMEOUT_SECONDS = 300;
export const DEFAULT_SEEDANCE_TIMEOUT_SECONDS = 300;
export const DEFAULT_SEEDREAM_TIMEOUT_SECONDS = 180;
export const DEFAULT_OPENAI_IMAGE_TIMEOUT_SECONDS = 180;
